...
//设置连接属性
func (this *Connection)SetProper(key string,value interface{}){
	this.properlocl.Lock()
	defer this.properlocl.Unlock()
	//添加一个属性
	this.property[key]=value
}
//获取连接属性
func (this *Connection)GetProper(key string)(interface{},error){
	this.properlocl.RLock()
	defer this.properlocl.RUnlock()
...
//移除连接属性
func (this *Connection)RemoveProper(key string){
	this.properlocl.Unlock()
	defer this.properlocl.Unlock()
